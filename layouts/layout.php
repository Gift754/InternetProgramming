...
<html lang="en" data-bs-theme="auto">
   <head>
      ...
      <meta name="theme-color" content="#18063dff">
   </head>
<?php
    }
        ...
        ?>
            <div class="p-5 mb-4 bg-body-tertiary rounded-3">
               <div class="container-fluid py-5">
                  <h1 class="display-5 fw-bold"><?php echo $conf['site_name']; ?></h1>
...
<?php if($_SERVER['PHP_SELF'] == '/tol/signup.php') { $Objforms->signup(); }else{ $Objforms->signin();} ?>
                  </div>
               </div>
               <div class="col-md-6">
                  <div class="h-100 p-5 bg-body-tertiary border rounded-3">
