...
public function content() {
    ...
    public function form_content() {
         global $conf, $Objforms, $ObjFncs;
        ?>
            <div class="row align-items-md-stretch">
               <div class="col-md-6">
                  <div class="h-100 p-5 text-bg-dark rounded-3">
                     <?php if(basename($_SERVER['PHP_SELF']) == 'signup.php') {$Objforms->signup(); } elseif(basename($_SERVER['PHP_SELF']) == 'signin.php') {$Objforms->signin(); } elseif(basename($_SERVER['PHP_SELF']) == 'verify_code.php') {$Objforms->verify_code(); } elseif(basename($_SERVER['PHP_SELF']) == 'forgot_password.php')  {$Objforms->forgot_password(); } elseif(basename($_SERVER['PHP_SELF']) == 'change_password.php')  {$Objforms->change_password(); } ?>
                  </div>
               </div>
               <div class="col-md-6">
                  <div class="h-100 p-5 bg-body-tertiary border rounded-3">
